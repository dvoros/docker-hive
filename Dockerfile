FROM dvoros/tez:HDP-2.6.0.3-hive2

RUN curl -s http://s3.amazonaws.com/public-repo-1.hortonworks.com/HDP/centos6/2.x/updates/2.6.0.3/tars/hive2/apache-hive-2.1.0.2.6.0.3-8-bin.tar.gz | tar -xz -C /usr/local
RUN cd /usr/local && ln -s apache-hive-2.1.0.2.6.0.3-8-bin hive
